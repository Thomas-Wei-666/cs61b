...
public class ArrayHeap<T> implements ExtrinsicPQ<T> {
    ...
    private void swim(int index) {
        ...
        while (inBounds(index) && inBounds(parent) && contents[index].priority() < contents[parent].priority()) {
            swap(index, parent);
            index = parent;
    ...
    private void sink(int index) {
        ...
        while (inBounds(index) && inBounds(child) && contents[index].priority() > contents[child].priority()) {
            swap(index, child);
            index = child;
            child = min(rightIndex(index), leftIndex(index));
        }
    ...
    public void changePriority(T item, double priority) {
        ...
        while (inBounds(index)) {
            if (contents[index].item().equals(index)) {
